...
<ul>
	...
	<li><a href="home1.php">REVIEWS</a></li>
...
<div class="slider">
   ...
   <img class="mySlides" src="web2/samsungbanner.jpg" width="1125px" height="230px" >
   <img class="mySlides" src="web2/iphonebanner.jpg" width="1125px" height="230px" >
   <img class="mySlides" src="web2/headphonebanner.jpg" width="1125px" height="230px" >
...
<div style="margin-top:-1460px; margin-left:1100px; position:absolute;">
		...
		<?php  if (isset($_SESSION['username'])) : ?>
			...
			<span> <a href="mAg.php?logout='1'" style="color: red;">logout</a> </span>
		<?php endif ?>
</div>
