...
<ul>
	...
	<h2 class="font">Samsung S7</h2>
	</div>
	
	<div class="box1">
		<img src="samsung%20s7.jpg" width= "500px" height="320px"/>
	</div>
	<div style="margin-left:250px;">
	<table>
	<?php 
				$sql = "SELECT * FROM samsung_s7";
    ...
    <div style="margin-top:100px; margin-left:300px;">
        <h2 style="color:white; margin-left:160px; padding:20px;">VIDEO REVIEW</h2>
        <iframe width="560" height="315" src="https://www.youtube.com/embed/OSJDCY32Z8E" frameborder="0" allowfullscreen></iframe>
    </div>
